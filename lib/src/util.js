 ...
 * @typedef {`${number}.${number}.${number}`} SemanticVersion A semantic version identifier
 */
 ...
 * @typedef {RequestOptions} NameSearchRequestOptions
 * @property {string} query A string to search for
 */
