...
class Player extends BaseAPIObject {
    constructor(rawResult, params) {
        ...
        const guildName = b.guild?.name ?? null;
        ...
        this.rank = {
            serverRank: b.rank.toUpperCase(),
            shortenedServerRank: (b.shortenedRank ?? b.rank).toUpperCase(),
            donatorRank: b.supportRank?.toUpperCase() ?? null,
