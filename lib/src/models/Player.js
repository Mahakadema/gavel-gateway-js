...
class Player extends BaseAPIObject {
    constructor(rawResult, params) {
        super(rawResult.requestedAt, rawResult.respondedAt, rawResult.receivedAt, rawResult.dataTimestamp, rawResult.body.version, VERSION, params.source);

        const a = rawResult.body.data[0];
