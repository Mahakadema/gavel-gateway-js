...
class Guild extends BaseAPIObject {
    constructor(json, params) {
        ...
        this.level = a.level;
        this.levelProgression = Math.min(1, Math.max(0, Math.round(a.xp) / 100));
        this.xp = Math.round(a.xp) / 100;
        this.xpRaw = Math.round(guildLevels[a.level].requirement * this.levelProgression);
        this.xpRawLower = Math.round(guildLevels[a.level].requirement * Math.max(0, this.levelProgression - 0.005));
        this.xpRawUpper = Math.round(guildLevels[a.level].requirement * Math.min(1, this.levelProgression + 0.005));
