...
const config = {
    ...
    routes: {
        ...
        ABILITY_TREE: {
            url: "https://api.wynncraft.com/v3/ability/tree/%v",
            cacheTime: 3_600_000,
            version: null,
        },
        ABILITY_MAP: {
            url: "https://api.wynncraft.com/v3/ability/map/%v",
            cacheTime: 3_600_000,
            version: null,
        },
        PLAYER_CHARACTER_AT: {
            url: "https://api.wynncraft.com/v3/player/%v/characters/%w/abilities",
            cacheTime: 600_000,
            version: null,
        },
        ASPECT_LIST: {
            url: "https://api.wynncraft.com/v3/aspects/%v",
        ...
        GUILD_LIST: {
            url: "https://api.wynncraft.com/v3/guild/list/guild?identifier=uuid",
            cacheTime: 3_600_000,
            version: null,
        },
        TERRITORY_LIST: {
