...
module.exports.fetchIngredients = async function (options) {
    ...
    if (parsedOptions.sprite)
        arr = arr.filter(v =>
            (typeof parsedOptions.sprite.id !== "number" || v.sprite.numericalId === parsedOptions.sprite.id) &&
            (typeof parsedOptions.sprite.damage !== "number" || v.sprite.damage === parsedOptions.sprite.damage) &&
            (typeof parsedOptions.sprite.customModelData !== "number" || v.sprite.customModelData === parsedOptions.sprite.customModelData) &&
            (typeof parsedOptions.sprite.name !== "string" || v.sprite.name === parsedOptions.sprite.name)
        );
